    ...
    <div>
        ...
        <div class="input-group w-50 m-auto">
            ...
            <div class="col-1 p-1 px-2">
                <button type="button" class="btn btn-primary w-100" @click="addAddressField">+</button>
            </div>
        </div>
        ...
        <div class="input-group w-50 m-auto">
            ...
            <div class="col-1 p-1 px-2">
                <button type="button" class="btn btn-primary w-100" @click="removeAddressField">-</button>
            </div>
        </div>
